    ...
    public function create(array $data, $files = [])
    {
        return $this->executeTransaction(
            ...
            function () use ($data, $files) {
                ...
                // Return complaint with notification data for after-commit
                return [
                    'complaint' => $this->repo->findById($complaint->id),
                    'notification_data' => [
                        'firebase' => [
            ...
            function ($result) {
                ...
                return $result['complaint']; // Return just the complaint to maintain original return type
            }
        );
    }
